...
// g++ -Wall -Wno-unused-function -std=c++17 -g -o ml2cpp-demo_DummyRegressor_Pipeline_freidman2.exe ml2cpp-demo_DummyRegressor_Pipeline_freidman2.cpp
...
namespace  {
	...
	namespace model {
		...
		tTable compute_regression(std::any scaler_output_2, std::any scaler_output_3, std::any scaler_output_4, std::any scaler_output_5) {
			...
			std::any  lEstimator = 499.09288446517394;
