...
// g++ -Wall -Wno-unused-function -std=c++17 -g -o ml2cpp-demo_GaussianNB_Pipeline_BinaryClass_10.exe ml2cpp-demo_GaussianNB_Pipeline_BinaryClass_10.cpp
	...
	namespace model {
		...
		tTable compute_classification_scores(std::any scaler_output_2, std::any scaler_output_3, std::any scaler_output_4, std::any scaler_output_5, std::any scaler_output_6, std::any scaler_output_7, std::any scaler_output_8, std::any scaler_output_9, std::any scaler_output_10, std::any scaler_output_11) {
			...
			lLogLikelihoodTable["Score"] = {
				-0.6931471805599453 + log_normal_cdf( scaler_output_2 , 0.6608885522985145 , 0.33846517479399624 ) + log_normal_cdf( scaler_output_3 , 0.05011958986810387 , 0.9213718643920022 ) + log_normal_cdf( scaler_output_4 , 0.010237135493869304 , 0.7801092671417778 ) + log_normal_cdf( scaler_output_5 , -0.1134260581927905 , 1.1435412522560795 ) + log_normal_cdf( scaler_output_6 , 0.091931902073065 , 1.0671211579648936 ) + log_normal_cdf( scaler_output_7 , 0.026957993139275754 , 0.9135431396544423 ) + log_normal_cdf( scaler_output_8 , 0.19931034565274267 , 0.9221241256214605 ) + log_normal_cdf( scaler_output_9 , 0.6831306672271085 , 0.2537663475858361 ) + log_normal_cdf( scaler_output_10 , -0.05290181072678812 , 0.8453258116879874 ) + log_normal_cdf( scaler_output_11 , -0.6905707153132041 , 0.20633922279541594 ),
				-0.6931471805599453 + log_normal_cdf( scaler_output_2 , -0.6608885522985144 , 0.7879874700875505 ) + log_normal_cdf( scaler_output_3 , -0.05011958986810381 , 1.0736041910309042 ) + log_normal_cdf( scaler_output_4 , -0.010237135493869402 , 1.2196811369719827 ) + log_normal_cdf( scaler_output_5 , 0.11342605819279053 , 0.8307278083896118 ) + log_normal_cdf( scaler_output_6 , -0.09193190207306502 , 0.9159758947975633 ) + log_normal_cdf( scaler_output_7 , -0.02695799313927582 , 1.0850033955573626 ) + log_normal_cdf( scaler_output_8 , -0.19931034565274264 , 0.9984266486101087 ) + log_normal_cdf( scaler_output_9 , -0.6831306672271085 , 0.8128986374018546 ) + log_normal_cdf( scaler_output_10 , 0.05290181072678807 , 1.149076987155667 ) + log_normal_cdf( scaler_output_11 , 0.6905707153132041 , 0.8398849535082032 ) 
			};
