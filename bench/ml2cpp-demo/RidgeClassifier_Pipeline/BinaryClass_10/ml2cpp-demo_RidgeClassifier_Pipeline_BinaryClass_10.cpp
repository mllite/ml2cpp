...
// g++ -Wall -Wno-unused-function -std=c++17 -g -o ml2cpp-demo_RidgeClassifier_Pipeline_BinaryClass_10.exe ml2cpp-demo_RidgeClassifier_Pipeline_BinaryClass_10.cpp
...
namespace  {
	...
	namespace model {
		...
		tTable compute_classification_scores(std::any scaler_output_2, std::any scaler_output_3, std::any scaler_output_4, std::any scaler_output_5, std::any scaler_output_6, std::any scaler_output_7, std::any scaler_output_8, std::any scaler_output_9, std::any scaler_output_10, std::any scaler_output_11) {
			...
			lTable["Score"] = { 
				-( -0.20739361763761077 * scaler_output_2 + -0.051779813244309726 * scaler_output_3 + -0.10422936739424425 * scaler_output_4 + 0.12186516510382539 * scaler_output_5 + -0.059764774143358 * scaler_output_6 + -0.10676849141960872 * scaler_output_7 + -0.0980398845070273 * scaler_output_8 + -0.22895057555160758 * scaler_output_9 + 0.016410445391457234 * scaler_output_10 + 0.24204842357819406 * scaler_output_11 + 1.1712211971289998e-17 ),
				-0.20739361763761077 * scaler_output_2 + -0.051779813244309726 * scaler_output_3 + -0.10422936739424425 * scaler_output_4 + 0.12186516510382539 * scaler_output_5 + -0.059764774143358 * scaler_output_6 + -0.10676849141960872 * scaler_output_7 + -0.0980398845070273 * scaler_output_8 + -0.22895057555160758 * scaler_output_9 + 0.016410445391457234 * scaler_output_10 + 0.24204842357819406 * scaler_output_11 + 1.1712211971289998e-17 
			} ;
			lTable["Proba"] = { 
				std::any(),
