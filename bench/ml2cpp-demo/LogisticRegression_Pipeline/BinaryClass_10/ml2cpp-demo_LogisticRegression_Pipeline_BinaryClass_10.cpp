...
// g++ -Wall -Wno-unused-function -std=c++17 -g -o ml2cpp-demo_LogisticRegression_Pipeline_BinaryClass_10.exe ml2cpp-demo_LogisticRegression_Pipeline_BinaryClass_10.cpp
...
namespace  {
	...
	namespace model {
		...
		tTable compute_classification_scores(std::any scaler_output_2, std::any scaler_output_3, std::any scaler_output_4, std::any scaler_output_5, std::any scaler_output_6, std::any scaler_output_7, std::any scaler_output_8, std::any scaler_output_9, std::any scaler_output_10, std::any scaler_output_11) {
			...
			lScores["Score"] = { 
				-( -0.9462587171612229 * scaler_output_2 + -0.1357152745804861 * scaler_output_3 + -0.5797229218880029 * scaler_output_4 + 0.49299281062828876 * scaler_output_5 + -0.38750936682853504 * scaler_output_6 + -0.6623150291871887 * scaler_output_7 + -0.37294084180684156 * scaler_output_8 + -1.0705891561740282 * scaler_output_9 + 0.13401488752124088 * scaler_output_10 + 1.1495278040879098 * scaler_output_11 + 0.5312675782144471 ),
				-0.9462587171612229 * scaler_output_2 + -0.1357152745804861 * scaler_output_3 + -0.5797229218880029 * scaler_output_4 + 0.49299281062828876 * scaler_output_5 + -0.38750936682853504 * scaler_output_6 + -0.6623150291871887 * scaler_output_7 + -0.37294084180684156 * scaler_output_8 + -1.0705891561740282 * scaler_output_9 + 0.13401488752124088 * scaler_output_10 + 1.1495278040879098 * scaler_output_11 + 0.5312675782144471
			};
