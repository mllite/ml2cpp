...
// g++ -Wall -Wno-unused-function -std=c++17 -g -o ml2cpp-demo_CalibratedClassifierCV_sigmoid_Pipeline_BinaryClass_10.exe ml2cpp-demo_CalibratedClassifierCV_sigmoid_Pipeline_BinaryClass_10.cpp
	...
	namespace model {
		...
		namespace BestEstimator_0 {
			...
			tTable compute_classification_scores(std::any scaler_output_2, std::any scaler_output_3, std::any scaler_output_4, std::any scaler_output_5, std::any scaler_output_6, std::any scaler_output_7, std::any scaler_output_8, std::any scaler_output_9, std::any scaler_output_10, std::any scaler_output_11) {
				...
				lTable["Proba"] = { 
					1.0 - logistic(3.3640840384918063 * coalesce( std::any() , lNodeValue [ 1 ] ) + -0.9661855827081625),
					logistic(3.3640840384918063 * coalesce( std::any() , lNodeValue [ 1 ] ) + -0.9661855827081625) 
				} ;
		...
		namespace BestEstimator_1 {
			...
			tTable compute_classification_scores(std::any scaler_output_2, std::any scaler_output_3, std::any scaler_output_4, std::any scaler_output_5, std::any scaler_output_6, std::any scaler_output_7, std::any scaler_output_8, std::any scaler_output_9, std::any scaler_output_10, std::any scaler_output_11) {
				...
				lTable["Proba"] = { 
					1.0 - logistic(2.752630131460535 * coalesce( std::any() , lNodeValue [ 1 ] ) + -1.597109346935524),
					logistic(2.752630131460535 * coalesce( std::any() , lNodeValue [ 1 ] ) + -1.597109346935524) 
				} ;
				int lBestClass = get_arg_max( lTable["Proba"] );
				auto lDecision = lClasses[lBestClass];
				lTable["Decision"] = { lDecision } ;
		...
		namespace BestEstimator_2 {
			...
			tTable compute_classification_scores(std::any scaler_output_2, std::any scaler_output_3, std::any scaler_output_4, std::any scaler_output_5, std::any scaler_output_6, std::any scaler_output_7, std::any scaler_output_8, std::any scaler_output_9, std::any scaler_output_10, std::any scaler_output_11) {
				...
				lTable["Proba"] = { 
					1.0 - logistic(3.650659014145949 * coalesce( std::any() , lNodeValue [ 1 ] ) + -1.2527629098223438),
					logistic(3.650659014145949 * coalesce( std::any() , lNodeValue [ 1 ] ) + -1.2527629098223438) 
				} ;
				int lBestClass = get_arg_max( lTable["Proba"] );
				auto lDecision = lClasses[lBestClass];
				lTable["Decision"] = { lDecision } ;
		...
		namespace BestEstimator_3 {
			...
			tTable compute_classification_scores(std::any scaler_output_2, std::any scaler_output_3, std::any scaler_output_4, std::any scaler_output_5, std::any scaler_output_6, std::any scaler_output_7, std::any scaler_output_8, std::any scaler_output_9, std::any scaler_output_10, std::any scaler_output_11) {
				...
				lTable["Proba"] = { 
					1.0 - logistic(4.062903184000669 * coalesce( std::any() , lNodeValue [ 1 ] ) + -2.3978968871297437),
					logistic(4.062903184000669 * coalesce( std::any() , lNodeValue [ 1 ] ) + -2.3978968871297437) 
				} ;
				int lBestClass = get_arg_max( lTable["Proba"] );
				auto lDecision = lClasses[lBestClass];
				lTable["Decision"] = { lDecision } ;
