...
// g++ -Wall -Wno-unused-function -std=c++17 -g -o ml2cpp-demo_CalibratedClassifierCV_isotonic_FourClass_100.exe ml2cpp-demo_CalibratedClassifierCV_isotonic_FourClass_100.cpp
...
namespace  {
	...
	namespace BestEstimator_0 {
		...
		std::map<std::any, tIsotonicData> lIsotonicData_0 = {
			...
			{ 0 ,	{ 
					...
					{ 0.0, 0.5, 0.07692307692307693, 0.07692307692307693, 0.0 },
					{ 0.5, 0.875, 0.07692307692307693, 0.3333333333333333, 0.6837606837606837 },
					{ 0.875, 1.0, 0.3333333333333333, 0.6, 2.1333333333333333 },
					{ 1.0, 1.79769313486231e+308, 0.6, 0.6, 0.0 },
				} },
			{ 1 ,	{ 
					{ -1.79769313486231e+308, 0.0, 0.23809523809523808, 0.23809523809523808, 0.0 },
					{ 0.0, 0.3333333333333333, 0.23809523809523808, 0.23809523809523808, 0.0 },
					{ 0.3333333333333333, 1.0, 0.23809523809523808, 0.3333333333333333, 0.14285714285714282 },
					{ 1.0, 1.79769313486231e+308, 0.3333333333333333, 0.3333333333333333, 0.0 },
				} },
			{ 2 ,	{ 
					{ -1.79769313486231e+308, 0.0, 0.2, 0.2, 0.0 },
					{ 0.0, 0.125, 0.2, 0.2, 0.0 },
					{ 0.125, 0.16666666666666666, 0.2, 0.5, 7.200000000000001 },
					{ 0.16666666666666666, 1.0, 0.5, 0.5, 0.0 },
					{ 1.0, 1.79769313486231e+308, 0.5, 0.5, 0.0 },
				} },
			{ 3 ,	{ 
					{ -1.79769313486231e+308, 0.0, 0.25, 0.25, 0.0 },
					{ 0.0, 1.0, 0.25, 0.25, 0.0 },
					{ 1.0, 1.79769313486231e+308, 0.25, 0.25, 0.0 },
				} },
		};
	...
	namespace BestEstimator_1 {
		...
		std::map<std::any, tIsotonicData> lIsotonicData_1 = {
					 // {xmin, xmax, ymin, ymax, coeff}
			{ 0 ,	{ 
					{ -1.79769313486231e+308, 0.0, 0.23529411764705882, 0.23529411764705882, 0.0 },
					{ 0.0, 0.5, 0.23529411764705882, 0.23529411764705882, 0.0 },
					{ 0.5, 1.0, 0.23529411764705882, 0.2857142857142857, 0.10084033613445376 },
			...
			{ 2 ,	{ 
					{ -1.79769313486231e+308, 0.0, 0.15, 0.15, 0.0 },
					{ 0.0, 0.5, 0.15, 0.15, 0.0 },
					{ 0.5, 1.0, 0.15, 0.75, 1.2 },
					{ 1.0, 1.79769313486231e+308, 0.75, 0.75, 0.0 },
				} },
			{ 3 ,	{ 
					{ -1.79769313486231e+308, 0.0, 0.19047619047619047, 0.19047619047619047, 0.0 },
					{ 0.0, 1.0, 0.19047619047619047, 0.6666666666666666, 0.47619047619047616 },
	...
	namespace BestEstimator_2 {
		...
		std::map<std::any, tIsotonicData> lIsotonicData_2 = {
			...
			{ 0 ,	{ 
					...
					{ 0.0, 0.2, 0.11764705882352941, 0.11764705882352941, 0.0 },
					{ 0.2, 1.0, 0.11764705882352941, 0.5714285714285714, 0.5672268907563024 },
					{ 1.0, 1.79769313486231e+308, 0.5714285714285714, 0.5714285714285714, 0.0 },
				} },
			{ 1 ,	{ 
					{ -1.79769313486231e+308, 0.0, 0.25, 0.25, 0.0 },
					{ 0.0, 1.0, 0.25, 0.25, 0.0 },
			...
			{ 2 ,	{ 
					{ -1.79769313486231e+308, 0.0, 0.05555555555555555, 0.05555555555555555, 0.0 },
					{ 0.0, 1.0, 0.05555555555555555, 0.8333333333333334, 0.7777777777777778 },
					{ 1.0, 1.79769313486231e+308, 0.8333333333333334, 0.8333333333333334, 0.0 },
				} },
			{ 3 ,	{ 
					{ -1.79769313486231e+308, 0.0, 0.125, 0.125, 0.0 },
					{ 0.0, 0.6, 0.125, 0.4, 0.45833333333333337 },
					{ 0.6, 0.8333333333333334, 0.4, 0.4, 0.0 },
					{ 0.8333333333333334, 1.0, 0.4, 0.6666666666666666, 1.6 },
					{ 1.0, 1.79769313486231e+308, 0.6666666666666666, 0.6666666666666666, 0.0 },
				} },
		};
	...
	namespace BestEstimator_3 {
		...
		std::map<std::any, tIsotonicData> lIsotonicData_3 = {
					 // {xmin, xmax, ymin, ymax, coeff}
			{ 0 ,	{ 
					{ -1.79769313486231e+308, 0.0, 0.0625, 0.0625, 0.0 },
					{ 0.0, 0.9375, 0.0625, 0.5714285714285714, 0.5428571428571428 },
					{ 0.9375, 1.0, 0.5714285714285714, 1.0, 6.857142857142858 },
					{ 1.0, 1.79769313486231e+308, 1.0, 1.0, 0.0 },
				} },
			{ 1 ,	{ 
					{ -1.79769313486231e+308, 0.0, 0.2727272727272727, 0.2727272727272727, 0.0 },
					{ 0.0, 0.0625, 0.2727272727272727, 0.3076923076923077, 0.55944055944056 },
					{ 0.0625, 1.0, 0.3076923076923077, 0.3076923076923077, 0.0 },
					{ 1.0, 1.79769313486231e+308, 0.3076923076923077, 0.3076923076923077, 0.0 },
				} },
			{ 2 ,	{ 
					{ -1.79769313486231e+308, 0.0, 0.20833333333333334, 0.20833333333333334, 0.0 },
					{ 0.0, 1.0, 0.20833333333333334, 0.20833333333333334, 0.0 },
					{ 1.0, 1.79769313486231e+308, 0.20833333333333334, 0.20833333333333334, 0.0 },
				} },
			{ 3 ,	{ 
					{ -1.79769313486231e+308, 0.0, 0.21052631578947367, 0.21052631578947367, 0.0 },
					{ 0.0, 0.5, 0.21052631578947367, 0.21052631578947367, 0.0 },
					{ 0.5, 1.0, 0.21052631578947367, 0.4, 0.3789473684210527 },
