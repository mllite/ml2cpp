...
// g++ -Wall -Wno-unused-function -std=c++17 -g -o ml2cpp-demo_CalibratedClassifierCV_isotonic_BinaryClass_100.exe ml2cpp-demo_CalibratedClassifierCV_isotonic_BinaryClass_100.cpp
...
namespace  {
	...
	namespace BestEstimator_0 {
		...
		std::map<std::any, tIsotonicData> lIsotonicData_0 = {
			...
			{ 1 ,	{ 
					...
					{ 0.0, 1.0, 0.2, 0.8, 0.6000000000000001 },
	...
	namespace BestEstimator_1 {
		...
		std::map<std::any, tIsotonicData> lIsotonicData_1 = {
					 // {xmin, xmax, ymin, ymax, coeff}
			{ 1 ,	{ 
					{ -1.79769313486231e+308, 0.0, 0.45454545454545453, 0.45454545454545453, 0.0 },
					{ 0.0, 1.0, 0.45454545454545453, 0.5555555555555556, 0.10101010101010105 },
					{ 1.0, 1.79769313486231e+308, 0.5555555555555556, 0.5555555555555556, 0.0 },
				} },
		};
	...
	namespace BestEstimator_3 {
		...
		std::map<std::any, tIsotonicData> lIsotonicData_3 = {
			...
			{ 1 ,	{ 
					...
					{ 0.0, 1.0, 0.1111111111111111, 0.7272727272727273, 0.6161616161616161 },
					{ 1.0, 1.79769313486231e+308, 0.7272727272727273, 0.7272727272727273, 0.0 },
				} },
		};
