...
// g++ -Wall -Wno-unused-function -std=c++17 -g -o ml2cpp-demo_SGDRegressor_freidman1.exe ml2cpp-demo_SGDRegressor_freidman1.cpp
...
namespace  {
	...
	tTable compute_regression(std::any Feature_0, std::any Feature_1, std::any Feature_2, std::any Feature_3, std::any Feature_4, std::any Feature_5, std::any Feature_6, std::any Feature_7, std::any Feature_8, std::any Feature_9) {
		...
		std::any  lEstimator = 4.2949289603855165 * Feature_0 + 9.30548910433408 * Feature_1 + -0.40939223760950144 * Feature_2 + 8.380434277667748 * Feature_3 + 4.38000139606453 * Feature_4 + 0.23891418459236594 * Feature_5 + -0.09852518314303099 * Feature_6 + 1.130625412325164 * Feature_7 + -0.1246982472544826 * Feature_8 + -1.2307425650367843 * Feature_9 + 2.4721377769961768;
