...
// g++ -Wall -Wno-unused-function -std=c++17 -g -o ml2cpp-demo_RidgeClassifier_BinaryClass_10.exe ml2cpp-demo_RidgeClassifier_BinaryClass_10.cpp
...
namespace  {
	...
	tTable compute_classification_scores(std::any Feature_0, std::any Feature_1, std::any Feature_2, std::any Feature_3, std::any Feature_4, std::any Feature_5, std::any Feature_6, std::any Feature_7, std::any Feature_8, std::any Feature_9) {
		...
		lTable["Score"] = { 
			-( -0.24482111136698811 * Feature_0 + -0.05480831949582957 * Feature_1 + -0.09737399596765046 * Feature_2 + 0.11309131819619095 * Feature_3 + -0.05408153313166272 * Feature_4 + -0.08073127045989231 * Feature_5 + -0.10063247453666874 * Feature_6 + -0.10132364116364032 * Feature_7 + 0.015361834940902186 * Feature_8 + 0.27093798289506543 * Feature_9 + 0.043508943293560386 ),
			-0.24482111136698811 * Feature_0 + -0.05480831949582957 * Feature_1 + -0.09737399596765046 * Feature_2 + 0.11309131819619095 * Feature_3 + -0.05408153313166272 * Feature_4 + -0.08073127045989231 * Feature_5 + -0.10063247453666874 * Feature_6 + -0.10132364116364032 * Feature_7 + 0.015361834940902186 * Feature_8 + 0.27093798289506543 * Feature_9 + 0.043508943293560386 
		} ;
		lTable["Proba"] = { 
			std::any(),
