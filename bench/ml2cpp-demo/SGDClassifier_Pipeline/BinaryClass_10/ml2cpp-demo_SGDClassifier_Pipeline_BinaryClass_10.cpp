...
// g++ -Wall -Wno-unused-function -std=c++17 -g -o ml2cpp-demo_SGDClassifier_Pipeline_BinaryClass_10.exe ml2cpp-demo_SGDClassifier_Pipeline_BinaryClass_10.cpp
...
namespace  {
	...
	namespace model {
		...
		tTable compute_classification_scores(std::any scaler_output_2, std::any scaler_output_3, std::any scaler_output_4, std::any scaler_output_5, std::any scaler_output_6, std::any scaler_output_7, std::any scaler_output_8, std::any scaler_output_9, std::any scaler_output_10, std::any scaler_output_11) {
			...
			lTable["Score"] = { 
				-( -18.09384697707183 * scaler_output_2 + -5.634950708680156 * scaler_output_3 + -22.890795470952884 * scaler_output_4 + 8.51690545125801 * scaler_output_5 + -10.632514441551288 * scaler_output_6 + -10.570303325026561 * scaler_output_7 + -7.447761014419324 * scaler_output_8 + -20.160710894298305 * scaler_output_9 + 4.951061879597484 * scaler_output_10 + 21.440863000190713 * scaler_output_11 + 7.364557975090993 ),
				-18.09384697707183 * scaler_output_2 + -5.634950708680156 * scaler_output_3 + -22.890795470952884 * scaler_output_4 + 8.51690545125801 * scaler_output_5 + -10.632514441551288 * scaler_output_6 + -10.570303325026561 * scaler_output_7 + -7.447761014419324 * scaler_output_8 + -20.160710894298305 * scaler_output_9 + 4.951061879597484 * scaler_output_10 + 21.440863000190713 * scaler_output_11 + 7.364557975090993 
			} ;
			lTable["Proba"] = { 
				std::any(),
