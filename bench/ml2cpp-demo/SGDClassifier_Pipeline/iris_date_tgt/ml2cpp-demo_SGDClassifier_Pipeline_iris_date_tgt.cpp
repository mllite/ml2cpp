...
// g++ -Wall -Wno-unused-function -std=c++17 -g -o ml2cpp-demo_SGDClassifier_Pipeline_iris_date_tgt.exe ml2cpp-demo_SGDClassifier_Pipeline_iris_date_tgt.cpp
...
namespace  {
	...
	namespace model {
		...
		tTable compute_classification_scores(std::any scaler_output_2, std::any scaler_output_3, std::any scaler_output_4, std::any scaler_output_5) {
			...
			std::any score_0 = -3.320347835200699 * scaler_output_2 + 9.677334885030758 * scaler_output_3 + -11.79617779060231 * scaler_output_4 + -10.95555837356936 * scaler_output_5 + -19.65670811397497;
	
			std::any score_1 = -0.3983457653377626 * scaler_output_2 + -2.2373902624652473 * scaler_output_3 + 5.9360920125331225 * scaler_output_4 + -7.428248556575141 * scaler_output_5 + -1.6456561290829006;
	
			std::any score_2 = -9.071879587519737 * scaler_output_2 + -1.1614641128009788 * scaler_output_3 + 33.32805436806505 * scaler_output_4 + 27.339517872047768 * scaler_output_5 + -36.438169442817234;
