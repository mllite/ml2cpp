...
// g++ -Wall -Wno-unused-function -std=c++17 -g -o ml2cpp-demo_SGDRegressor_Pipeline_freidman1.exe ml2cpp-demo_SGDRegressor_Pipeline_freidman1.cpp
...
namespace  {
	...
	namespace model {
		...
		tTable compute_regression(std::any scaler_output_2, std::any scaler_output_3, std::any scaler_output_4, std::any scaler_output_5, std::any scaler_output_6, std::any scaler_output_7, std::any scaler_output_8, std::any scaler_output_9, std::any scaler_output_10, std::any scaler_output_11) {
			...
			std::any  lEstimator = 1.3416093005209035 * scaler_output_2 + 2.980031469668966 * scaler_output_3 + -0.0630966225626179 * scaler_output_4 + 2.66190901748273 * scaler_output_5 + 1.5681628498153715 * scaler_output_6 + -0.055656827804283035 * scaler_output_7 + -0.11513222759485107 * scaler_output_8 + 0.21842630598136417 * scaler_output_9 + 0.011765288774465112 * scaler_output_10 + -0.3202019920391579 * scaler_output_11 + 15.325579820157202;
