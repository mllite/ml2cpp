...
// g++ -Wall -Wno-unused-function -std=c++17 -g -o ml2cpp-demo_SGDRegressor_Pipeline_freidman2.exe ml2cpp-demo_SGDRegressor_Pipeline_freidman2.cpp
...
namespace  {
	...
	namespace model {
		...
		tTable compute_regression(std::any scaler_output_2, std::any scaler_output_3, std::any scaler_output_4, std::any scaler_output_5) {
			...
			std::any  lEstimator = 20.08118787773109 * scaler_output_2 + 236.15790799017185 * scaler_output_3 + 271.59668274632946 * scaler_output_4 + 23.954762116414138 * scaler_output_5 + 498.8406809564805;
