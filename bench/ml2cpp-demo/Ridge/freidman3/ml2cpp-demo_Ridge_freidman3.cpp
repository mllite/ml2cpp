...
// g++ -Wall -Wno-unused-function -std=c++17 -g -o ml2cpp-demo_Ridge_freidman3.exe ml2cpp-demo_Ridge_freidman3.cpp
...
namespace  {
	...
	tTable compute_regression(std::any Feature_0, std::any Feature_1, std::any Feature_2, std::any Feature_3) {
		...
		std::any  lEstimator = -0.003113722589669426 * Feature_0 + 0.00018773966985258646 * Feature_1 + 0.5093630649120322 * Feature_2 + 0.006189867303249628 * Feature_3 + 1.0115146862330635;
