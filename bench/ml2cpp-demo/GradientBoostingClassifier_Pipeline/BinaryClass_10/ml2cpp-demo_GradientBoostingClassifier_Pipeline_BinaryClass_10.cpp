...
// g++ -Wall -Wno-unused-function -std=c++17 -g -o ml2cpp-demo_GradientBoostingClassifier_Pipeline_BinaryClass_10.exe ml2cpp-demo_GradientBoostingClassifier_Pipeline_BinaryClass_10.cpp
	...
	namespace model {
		...
		namespace SubModel_0_0 {
			...
			int get_decision_tree_node_index(std::any scaler_output_2, std::any scaler_output_3, std::any scaler_output_4, std::any scaler_output_5, std::any scaler_output_6, std::any scaler_output_7, std::any scaler_output_8, std::any scaler_output_9, std::any scaler_output_10, std::any scaler_output_11) {
				int lNodeIndex = (scaler_output_11 <= 0.07101128064095974) ? ( (scaler_output_7 <= 1.7556507587432861) ? ( (scaler_output_7 <= -0.8114416599273682) ? ( 3 ) : ( 4 ) ) : ( 5 ) ) : ( (scaler_output_8 <= 1.7904822826385498) ? ( 7 ) : ( 8 ) );
