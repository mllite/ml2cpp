...
// g++ -Wall -Wno-unused-function -std=c++17 -g -o ml2cpp-demo_Ridge_Pipeline_freidman3.exe ml2cpp-demo_Ridge_Pipeline_freidman3.cpp
...
namespace  {
	...
	namespace model {
		...
		tTable compute_regression(std::any scaler_output_2, std::any scaler_output_3, std::any scaler_output_4, std::any scaler_output_5) {
			...
			std::any  lEstimator = -0.08274729334711063 * scaler_output_2 + 0.08650495811443386 * scaler_output_3 + 0.16805102977200398 * scaler_output_4 + 0.016669269325658202 * scaler_output_5 + 1.3612342030259192;
