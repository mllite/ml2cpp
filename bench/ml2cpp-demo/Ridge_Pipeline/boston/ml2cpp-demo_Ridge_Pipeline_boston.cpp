...
// g++ -Wall -Wno-unused-function -std=c++17 -g -o ml2cpp-demo_Ridge_Pipeline_boston.exe ml2cpp-demo_Ridge_Pipeline_boston.cpp
...
namespace  {
	...
	namespace model {
		...
		tTable compute_regression(std::any scaler_output_2, std::any scaler_output_3, std::any scaler_output_4, std::any scaler_output_5, std::any scaler_output_6, std::any scaler_output_7, std::any scaler_output_8, std::any scaler_output_9, std::any scaler_output_10, std::any scaler_output_11, std::any scaler_output_12, std::any scaler_output_13, std::any scaler_output_14) {
			...
			std::any  lEstimator = -0.7776371595895113 * scaler_output_2 + 0.8844810620760167 * scaler_output_3 + 0.12972941393644075 * scaler_output_4 + 0.628347873886901 * scaler_output_5 + -1.715693553387115 * scaler_output_6 + 3.2638839632514487 * scaler_output_7 + -0.5632473043723891 * scaler_output_8 + -2.859205274488446 * scaler_output_9 + 2.2733393274359246 * scaler_output_10 + -1.9673963139264499 * scaler_output_11 + -2.1521604622974873 * scaler_output_12 + 0.931970200880803 * scaler_output_13 + -2.8625961592638216 * scaler_output_14 + 22.578960396039605;
