...
// g++ -Wall -Wno-unused-function -std=c++17 -g -o ml2cpp-demo_Ridge_Pipeline_freidman2.exe ml2cpp-demo_Ridge_Pipeline_freidman2.cpp
...
namespace  {
	...
	namespace model {
		...
		tTable compute_regression(std::any scaler_output_2, std::any scaler_output_3, std::any scaler_output_4, std::any scaler_output_5) {
			...
			std::any  lEstimator = 19.82628338622646 * scaler_output_2 + 233.1024832864978 * scaler_output_3 + 268.34135430892934 * scaler_output_4 + 23.644358611143918 * scaler_output_5 + 499.0928844651738;
