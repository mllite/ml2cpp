...
// g++ -Wall -Wno-unused-function -std=c++17 -g -o ml2cpp-demo_Ridge_Pipeline_RandomReg_10.exe ml2cpp-demo_Ridge_Pipeline_RandomReg_10.cpp
...
namespace  {
	...
	namespace model {
		...
		tTable compute_regression(std::any scaler_output_2, std::any scaler_output_3, std::any scaler_output_4, std::any scaler_output_5, std::any scaler_output_6, std::any scaler_output_7, std::any scaler_output_8, std::any scaler_output_9, std::any scaler_output_10, std::any scaler_output_11) {
			...
			std::any  lEstimator = 34.936299642397564 * scaler_output_2 + 73.7100373876979 * scaler_output_3 + 87.30118845385823 * scaler_output_4 + 37.20035356629381 * scaler_output_5 + 56.82441624467638 * scaler_output_6 + 78.45109933480484 * scaler_output_7 + 37.88433427402308 * scaler_output_8 + 39.10649196699403 * scaler_output_9 + 92.64892488769321 * scaler_output_10 + 52.57456364033037 * scaler_output_11 + 26.40585273065242;
